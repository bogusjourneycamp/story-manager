...
class TestLocationValidity(unittest.TestCase):
    ...
    def test_invalid_man(self):
        self.assertEqual(
            self.locationValidator.check_location_validity("man"), UNDERSCORE_COUNT_OFF
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("MAN"), UNDERSCORE_COUNT_OFF
        )
    ...
    def test_invalid_letter_count(self):
        self.assertEqual(
            self.locationValidator.check_location_validity("AB_1:15"), LETTER_COUNT_OFF
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("_1:15"), LETTER_COUNT_OFF
        )
    ...
    def test_invalid_colon_count(self):
        self.assertEqual(
            self.locationValidator.check_location_validity("A_130"), COLON_COUNT_OFF
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("K_7:45:00"), COLON_COUNT_OFF
        )

    def test_invalid_hour(self):
        self.assertEqual(
            self.locationValidator.check_location_validity("A_a:30"), INVALID_HOUR
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("A_K:30"), INVALID_HOUR
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("A_0:30"), INVALID_HOUR
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("A_13:30"), INVALID_HOUR
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("A_:30"), INVALID_HOUR
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("A_111:30"), INVALID_HOUR
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("A_.:30"), INVALID_HOUR
        )
    ...
    def test_invalid_minute(self):
        self.assertEqual(
            self.locationValidator.check_location_validity("I_1:01"), INVALID_MINUTE
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("I_1:-"), INVALID_MINUTE
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("I_1:50"), INVALID_MINUTE
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("I_4:000"), INVALID_MINUTE
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("I_4:00k"), INVALID_MINUTE
        )
        self.assertEqual(
            self.locationValidator.check_location_validity("I_4:r"), INVALID_MINUTE
        )
...
class TestTreeValidity(unittest.TestCase):
    ...
    def test_simple_tree(self):
        self.assertEqual(
            self.treeValidator.check_tree_validity(test_data.simple_tree), VALID
        )

    def test_complex_tree(self):
        self.assertEqual(
            self.treeValidator.check_tree_validity(test_data.complex_tree), VALID
        )
...
{ 
  ...
  "choices": []
    ...
    """
        ...
        self.assertEqual(
            self.treeValidator.check_tree_validity(invalid_loc), UNDERSCORE_COUNT_OFF
        )
...
{ 
  ...
  "choices": []
    ...
    """
        ...
        self.assertEqual(
            self.treeValidator.check_tree_validity(no_text), NO_SELECTIONTEXT_IN_CHOICE
        )
...
{ 
  ...
  "choices": []
    ...
    """
        ...
        self.assertEqual(
            self.treeValidator.check_tree_validity(no_text), NO_STORYTEXT_IN_CHOICE
        )
...
{ 
  ...
  "storyText": "lorem ipsum"
    ...
    """
        ...
        self.assertEqual(
            self.treeValidator.check_tree_validity(no_choices), NO_CHOICES_IN_CHOICE
        )
